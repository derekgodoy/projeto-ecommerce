...
<thead>
<tr>
<th class="text-center"><strong>Id do Pedido</strong></th>
<th class="text-center"><strong>Id do Cliente</strong></th>
...
<?php		
    foreach ($result as $item){		?>
                ...
                <td class="text-center align-middle"><?php echo $item["id_cliente"]; ?></td>
				<td class="text-center align-middle"><?php echo $item["preco"]; ?></td>
                <td class="text-center align-middle"><?php echo $item["parcelas"]; ?></td>
                <td class="text-center align-middle"><?php echo $item["preco"]/$item["parcelas"]; ?></td>
				<td class="text-center align-middle">fazer select</td>
				</tr>
				<?php } ?>
